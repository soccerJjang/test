...
const LessonProRoomDetail = ( props ) => {
            ...
            <CommonContainer4 style={styles.CommonContainer4}>
                ...
                <InfoContainer>
                    <View style={{flexDirection: 'row', marginBottom: 16, justifyContent: 'space-between'}}>
                        <RN.Text>구력</RN.Text>
                        <RN.Text style={{color: 'gray'}}>{ user?.driver_distance ? `${user?.career}개월` : "0개월" }</RN.Text>
                    </View>
                    <View style={{flexDirection: 'row', marginBottom: 16, justifyContent: 'space-between'}}>
                        <RN.Text>나이</RN.Text>
                        <RN.Text style={{color: 'gray'}}>{ user?.driver_distance ? `${user?.birth}살` : "0살" }</RN.Text>
                    </View>
                    <View style={{flexDirection: 'row', marginBottom: 16, justifyContent: 'space-between'}}>
                ...
                <View style={{backgroundColor: 'white', height: 85, flexDirection: 'row', justifyContent: 'space-between'}}>
                    <PageButtonOn style={[styles.pageButtonOn, styles.pageButtonOn1]} onPress={()=>{navigation.pop()}}><PageBtnText style={styles.pageBtnText}>목록가기</PageBtnText></PageButtonOn>
...
export default LessonProRoomDetail;